...
CREATE TABLE `products` (
  ...
  `createdAt` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (`brands_id`) REFERENCES `brands` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);

INSERT INTO brands (brand_name) VALUES
("Sony"), ("Samsung"), ("LG"), ("Toshiba"), ("Acer"), ("HP");

-- Productos para Sony
INSERT INTO products (product_name, description, price, stock, brands_id) VALUES
